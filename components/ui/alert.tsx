...
const alertVariants = cva('relative w-full border-2 border-l-4 border-l-primary p-4', {
  variants: {
    variant: {
      default: 'bg-background text-foreground',
      destructive: 'border-destructive/50 border-l-destructive text-destructive',
    },
  },
  defaultVariants: {
    variant: 'default',
